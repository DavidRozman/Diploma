...
ordinary differential equations, therefore numerical methods are commonly used in the process. The conditions for 
existence and uniqueness of a solution are similar to those for ordinary differential equations, yet the solution
is often neither differentiable nor continuous. Laplace transform can be used to solve equations, altough the final 
result may not be expressed as an elementary function. Certain equations can still be solved using specific 
expression or variation of constant. Systems can be solved using a general method, altough numerical methods 
will be required most of the time in the process. Delay differential equations are useful as a tool to analyse
...
\begin{figure}[h]
    \includegraphics[width=10cm, height=10cm]{faza.png}
...
\begin{zgled}
    ...
    \begin{figure}[h]
        \includegraphics[height=8cm, width=10cm]{primer.jpg}
