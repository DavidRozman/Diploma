...
območju $u=r$ vrednost integrala na desni vedno bolj odvisna le od izraza $f(r)e^{-ar}$. Tako lahko
določimo $f(t)$ za $t\geq0$.

Poglejmo sedaj še drugi način za reševanje enačbe (2). Interval $(0,\infty)$ razbijemo na tri 
dele: $(0,\infty) = (0,u-d] + (u-d,u+d] + (u+d,\infty]$ za nek majhen $d$. Po aditivnosti določenega
integrala dobimo:
...
S tem izrekom smo dobili formulo za izračun inverzne funkcije pri Laplaceovi transformaciji, ki pa jo 
lahko še malo okrajšamo. Če vpeljemo novo spremenljivko $s=b+ir$ za $r\in[-T,T]$, dobimo:
